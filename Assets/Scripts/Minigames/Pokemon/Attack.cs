...
public class Attack : ScriptableObject
{
    ...
    public float damage = -10000; //default is -10000 just in case we want something that functions like an attack but does 0 damage or a negative idk
    public float healAmount = -10000; //if this is set to something other than -10000, it will heal the user for that amount
